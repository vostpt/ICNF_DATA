...
# Clean up rows where DISTRITO and CONCELHO have the same value
...
# Also rename columns for readability
...
# This can be done numerous times to create more steps for the Sankey
            ...
            [
                ...
                dbc.Col(
                    dcc.Dropdown(
                                ...
                                placeholder="Please select a year",  # gray, default text shown when no option is selected
